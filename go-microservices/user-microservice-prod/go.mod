module barqi.com/microservice/user
...
replace barqi.com/user/auth => ./auth

require (
	barqi.com/user/common v0.0.0-00010101000000-000000000000
	barqi.com/user/controllers v0.0.0-00010101000000-000000000000
...
require (
	barqi.com/user/auth v0.0.0-00010101000000-000000000000 // indirect
	barqi.com/user/utils v0.0.0-00010101000000-000000000000 // indirect
...
replace barqi.com/user/controllers => ./controllers
